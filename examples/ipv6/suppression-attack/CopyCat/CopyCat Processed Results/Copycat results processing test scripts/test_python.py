...
workbook = xlsxwriter.Workbook('Exp_1_1_energyConsumption.xlsx')
...
def process_line(x):
    ...
    try:
        if msgArray2[2] == "P":
            ...
            #print(type(msgArray3[1]))
            #entry.append([msgArray2[5],msgArray2[6],msgArray2[7],msgArray2[8]])
            #print(entry[0])
            if msgArray3[1] == "1":
