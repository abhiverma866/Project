...
timeout_function = function () {
    try{
        ...
        line = "Script timed out" + "\n"
        log_script.write(line);
        log_script.flush();
        ...
        line = "Generated Packets " + totalSent + " | " +  "ReceivedPackets " + totalReceived + "\n"
        log_script.write(line);
        log_script.flush();
        ...
        line  = "TL = " + totalLatency + " | " + " AE2ED = " + AE2ED + " | " +" PDR = " + PDR + "\n"
        log_script.write(line);
        log_script.flush();
        log.testOK();
    } catch (e) {
        log_script.close();
            log.log("Final results written to script.log closed \n");
